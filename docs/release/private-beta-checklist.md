...
- [ ] Obtenir par écrit le droit de distribuer la bêta avec Open-Meteo,
  LibreWXR et Google Maps effectivement utilisés, ou désactiver/remplacer
...
- Tout fournisseur cartographique autre que Google Maps tant que son droit de
  distribution n'est pas écrit et archivé.
